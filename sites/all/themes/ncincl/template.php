...
*/
/* Delete me to enable
function ncincl_preprocess_views_view_fields(&$variables) {
 ...
 * Implements hook_form_alter().
 */
function ncincl_form_alter(array &$form, array &$form_state = array(), $form_id = NULL) {
  if ($form_id) {
    switch ($form_id) {
      case 'search_form':
 ...
 */
function ncincl_search_form_wrapper($variables) {
 ...
 * @see hook_theme()
 */
function ncincl_theme(&$existing, $type, $theme, $path) {
  // Custom theme hooks:
...
function ncincl_preprocess_page(&$variables) {
...
function ncincl_links__system_main_menu($variables) {
  $html = "<div>Steve\n";
  $html .= "  <ul>\n";  
...
/**
    ...
    */
function ncincl_preprocess_search_result(&$variables) {
